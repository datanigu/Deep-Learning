...
#        print('y=',y)
        # Darcy things
        f_h = hidden_outputs # = f(h) = a
#        print('hidden_outputs',hidden_outputs)
#        print('hidden_outputs.shape',hidden_outputs.shape)
        f_prime_h = f_h*(1-f_h)
#        print('f_prime_h',f_prime_h)
#        print('f_prime_h.shape',f_prime_h.shape)

#        print('error shape',error.shape)
#        print('f_h.shape',f_h.shape)
#
...
#        print('f_prime_h',f_prime_h)
#        print('f_prime_a',f_prime_a.shape)
#

        # TODO: Backpropagated error terms - Replace these values with your calculations.
        output_error_term = -error

        hidden_error_term = hidden_error*f_prime_h
#        print('f_prime_h',f_prime_h.shape)
...
#        print('weights_hidden_to_output shape',self.weights_hidden_to_output.shape)
        ...
        assert(output_error_term.shape == (1,1))

        delta_weights_i_h += -self.lr*hidden_error_term*X.T
        # Weight step (hidden to output)
        delta_weights_h_o += -self.lr*(output_error_term.T*f_h).T#<------
        #delta_weights_h_o += -self.lr*output_error_term*f_h.T#<------
#        print('input to hidden',delta_weights_i_h.shape)
#        print('hidden to output',delta_weights_h_o.shape)
    ...
    def run(self, features):
        ...
        hidden_outputs = self.activation_function(hidden_inputs) # signals from hidden layer
#        print('RUN hidden_inputs.shape',hidden_inputs.shape)
#        print ('RUN hidden_outputs.shape',hidden_outputs.shape)
#        print('RUN features.shape, weights_input_to_hidden.shape',features.shape, self.weights_input_to_hidden.shape)
#        print('RUN self.weights_hidden_to_output',self.weights_hidden_to_output.shape)
